...
privileged aspect DeliveryController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> DeliveryController.showJson(@PathVariable("id") Long id) {
    ...
    @ResponseBody
    public ResponseEntity<String> DeliveryController.listJson() {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        try {
    ...
    public ResponseEntity<String> DeliveryController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> DeliveryController.createFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
    ...
    public ResponseEntity<String> DeliveryController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Delivery delivery = Delivery.fromJsonToDelivery(json);
    ...
    public ResponseEntity<String> DeliveryController.deleteFromJson(@PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Delivery delivery = Delivery.findDelivery(id);
