...
import com.epam.hack.choosebyspeed.web.ProductController;
...
privileged aspect ProductController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> ProductController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Product product = Product.fromJsonToProduct(json);
